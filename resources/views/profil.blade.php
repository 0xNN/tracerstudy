                ...
                <div class="tab-pane fade show active" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            {{-- <input type="hidden" name="f1_id"> --}}
                            <select class="form-control" type="text" name="f1_provinsi" id="f1_provinsi" onclick="alert(this.value)"></select>
                            </div>
                            <div class="col-sm-6">
                            <label for="f1_kabupaten" class="form-label">
                                Kabupaten
                            </label>
                            <select type="text" class="form-control" name="f1_kabupaten" id="f1_kabupaten"></select>
                            </div>
                        </div>
                        <div class="row">
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input class="form-control form-control-sm" type="text" name="f1_email" id="f1_email" value="{{ ($alumni['email'] == null) ? '': $alumni['email'] }}" readonly>
                        </div>
                        </div>
                        <div class="row">
                        <div class="col-sm-6">
                ...
                <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control form-control-sm" name="f1_nikayah" id="f1_nikayah" value="{{ $alumni['nik_ayah'] }}">
                        </div>
                        <div class="col-sm-6">
                            <label for="f1_namaayah" class="form-label">
                            Nama Ayah
                            </label>
                            <input type="text" class="form-control form-control-sm" name="f1_namaayah" id="f1_namaayah" value="{{ $alumni['nm_ayah'] }}">
                        </div>
                        </div>
                        <div class="row">
                        <div class="col-sm-6">
